...
-- https://de.classic.wowhead.com/quest=469/t"agliche-lieferung + old GTDB WotLK files
DELETE FROM `quest_request_items_locale` WHERE `ID` = 469 AND `locale` = 'deDE';
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(469, 'deDE', 'Guten Tag auch, $C. Kann ich Euch für ein Paar Stiefel interessieren? Vielleicht einige frisch gegerbte H"aute?', 0);
DELETE FROM `quest_offer_reward_locale` WHERE `ID` = 469 AND `locale` = 'deDE';
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(469, 'deDE', 'Hmm, das ist von Einar, oder? Er hat mir schon seit bald einer Woche seine H"aute nicht mehr pers"onlich geliefert. Er hat sicher wieder "Arger mit seiner Frau!$B$BVielleicht lasse ich meine Frau mal mit Sida sprechen...', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(473, 'deDE', '$N. Valstag kl"arte mich über Eure bisherigen Erfolge mit den Orcs des Drachenmalklans in Dun Algaz auf. Ihr seid $Gein:eine:r; $R von Wert.$B$BUnd ich habe eine Aufgabe für Euch.', 0);

-- Quest 484 - add missing data
-- https://de.classic.wowhead.com/quest=484/h"aute-junger-krokilisken + old GTDB WotLK files
DELETE FROM `quest_request_items_locale` WHERE `ID` = 484 AND `locale` = 'deDE';
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(484, 'deDE', '$N, nicht wahr? Habt Ihr meine H"aute?', 0);
DELETE FROM `quest_offer_reward_locale` WHERE `ID` = 484 AND `locale` = 'deDE';
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(484, 'deDE', 'Ihr habt gute Arbeit geleistet, $N. Die Qualit"at dieser H"aute ist superb. Ich muss so bald wie m"oglich mit dem Gerben dieser H"aute beginnen. Oh, bevor ich jedoch damit anfangen kann, habe ich noch eine andere Aufgabe zu erledigen. Ich denke, dass Ihr sie übernehmen k"onnt.', 0);
...
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(471, 'deDE', 'Mein Lehrling ist wie ein Sohn für mich. Wird hart für ihn sein, sein Leben mit nur einem Bein zu fristen.$B$BAh, $N, wie l"auft\'s? Habt Ihr meine H"aute?', 0);
DELETE FROM `quest_offer_reward_locale` WHERE `ID` = 471 AND `locale` = 'deDE';
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(471, 'deDE', 'Hmm... Ihr habt nicht zuf"allig Lust, bei mir in die Lehre zu gehen?$B$BHa! Nein, war nur ein Witz. Ihr seid sowieso viel zu alt. Ausserdem - nach Eurem Aussehen zu urteilen, habt Ihr wahrscheinlich andere Ambitionen im Leben. Dennoch habt Ihr da ein paar feine H"aute besorgt und ich werde damit etwas anfangen k"onnen.', 0);
...
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(279, 'deDE', 'Unsere H"andler werden nicht sicher sein, bis wir Gobbler und diese Murlocs losgeworden sind.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(281, 'deDE', 'Diese Kiste ist mit klauenartigen Kratzern übers"at und zeigt Spuren eines Wasserschadens. Das Aufbrechen enthüllt durchn"asstes und verfaultes Stroh, als w"are etwas Wertvolles in dieser Kiste aufbewahrt worden. Ihr durchwühlt das Stroh...$B$B... und findet einen Arm voll rot gef"arbter Flaschen.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(284, 'deDE', 'Dieses Fass ist weitgehend unberührt. Als Ihr es "offnet...$B$B... schl"agt Euch der stechende Geruch von K"ase entgegen. Er ist etwas feucht, aber immer noch schmackhaft!', 0);
...
(1239, 0, 'deDE', 'Wenn Ihr gewillt seid, Euch Geschichten anzuh"oren, die Eure Knochen zum Schlottern bringen und Euch das Fürchten lehren werden, dann holt Euch etwas zu trinken und setzt Euch hin...', 0);
...
INSERT INTO `quest_greeting_locale` (`ID`, `Type`, `locale`, `Greeting`, `VerifiedBuild`) VALUES
(2094, 0, 'deDE', 'Seid gegrüsst $C. Ich befinde mich gerade in einer etwas misslichen Lage, ich habe fast keine B"alge mehr.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(286, 'deDE', 'Der Kapit"an der Blind Princess wird erleichtert sein zu h"oren, dass seine kostbare Fracht geborgen wurde. Ihr habt Euch diesen Lohn durch die geleisteten Dienste wohl verdient.$B$BEs tut gut, verl"assliche Leute wie Euch zu kennen, insbesondere in so beschwerlichen Zeiten wie diesen.', 0);
...
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(289, 'deDE', 'Ich kann manchmal in meinen Tr"aumen das unselige St"ohnen meiner Brüder h"oren! Bitte, $Gguter Herr:gute Dame;, befreit sie von ihren Fesseln und lasst ihre Schreie verstummen.', 0);
...
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(292, 'deDE', 'Dieser S"aufer Fitzsimmons hat Euch zu mir geschickt? Nun, Ihr k"onnt ihm sagen, dass ich kein Ale übrig habe. Er wird wohl jemand anderes anbetteln müssen!', 0);
DELETE FROM `quest_offer_reward_locale` WHERE `ID` = 292 AND `locale` = 'deDE';
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(292, 'deDE', 'Ein Auge von Paleth? Erstaunlich! Hmm... irgendetwas stimmt nicht mit diesem hier. Ihr habt es auf einem der Schiffswracks gefunden? Das erkl"art einiges! Allerdings... wusste ich gar nicht, dass sie in der dritten Flotte ein solches Auge hatten...$B$BKein Wunder, dass Fitzsimmons so ver"angstigt war. Ein verfluchtes Auge von Paleth ist kein Grund zur Fr"ohlichkeit.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(293, 'deDE', 'Ein Auge von Paleth. Aber dieses hat viel Leid gesehen... es muss Zeuge einer schrecklichen, grauenhaften Trag"odie gewesen sein.$B$BLasst es mich reinigen, denn die Augen wurden geschaffen, um hell zu erstrahlen, und ihre Kr"afte k"onnen sehr gef"ahrlich sein, wenn sie wie dieses hier besudelt sind.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(472, 'deDE', 'Welch $Gmutiger:mutige:c; $C bringt Kunde aus Menethil? Ah, $N werdet Ihr genannt.$B$BIhr bringt Hoffnung in eine hoffnungslose Situation. Gut zu wissen, dass der junge Harlo überlebt hat. Auf der Flucht wurde ihm eine ernste Wunde zugefügt. Wir hatten kaum die Zeit, ihn auf dem Rücken des letzten überlebenden Reittiers unseres Regiments fortzuschicken.$B$BAber wir sind hier in einer gef"ahrlichen Lage. Dun Modr ist gefallen, und wir sind nur ein Schatten des grossen Regiments, das wir einmal waren.', 0);
...
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(303, 'deDE', 'Roggo konnte keinen Kontakt zu den Reserven herstellen. Wir müssen offensiven Druck auf dieses Lager der Dunkeleisenzwerge ausüben, $C. Und jetzt geht wieder da raus und erfüllt Eure Pflicht K"onig Magni gegenüber!', 0);
DELETE FROM `quest_offer_reward_locale` WHERE `ID` = 303 AND `locale` = 'deDE';
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(303, 'deDE', 'Ihr habt Eure Befehle gut ausgeführt, $C. Ihr habt bewiesen, dass Ihr ein tapferer Soldat und loyaler Diener K"onig Magnis\' seid, und dafür bewundere ich Euch. Durch den Druck, den Ihr auf das Lager der Dunkeleisenzwerge ausgeübt habt, haben wir jetzt eine Chance, sie für immer aus unseren Landen zu vertreiben... wenn nur die verdammte Reserve endlich auftauchen würde...', 0);
...
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(304, 'deDE', 'Konntet Ihr Balgaras den Niedertr"achtigen schon aufspüren, $C? Er weicht uns schon eine ganze Weile aus.', 0);
DELETE FROM `quest_offer_reward_locale` WHERE `ID` = 304 AND `locale` = 'deDE';
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(304, 'deDE', 'Balgaras der Niedertr"achtige ist endlich tot. Wenn sein Tod auch die vielen unschuldigen Zwerge nicht zurückbringt, die sinnlos durch seine Hand starben, so wird dies doch zum Seelenfrieden derer beitragen, die überlebt haben. Nachdem Balgaras nun tot ist, sollte es ein Leichtes sein, mit dem restlichen Dunkeleisenpack fertig zu werden. Jetzt müssen wir den Abschaum ausl"oschen, bevor ein neuer Anführer in diese Gegend entsandt wird.$B$BIhr habt Eure Sache gut gemacht, $C.', 0);
...
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(378, 'deDE', 'Ich werde nicht zulassen, dass n"arrische Menschen-Bürokratie zwergischen Angelegenheiten in die Quere kommt, $N. Kam Tiefenzorn ist erwiesenermassen einer der Verschw"orer des Angriffs auf den Thandolübergang. K"onig Magnis gute Gefolgsleute liessen dank Tiefenzorns Verrat ihr Leben. Den Menschen mag es genug sein, Tiefenzorn im Verlies verrotten zu lassen, aber ich werde nicht mehr ruhig schlafen, bis Tiefenzorn erschlagen ist.', 0);
DELETE FROM `quest_offer_reward_locale` WHERE `ID` = 378 AND `locale` = 'deDE';
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(378, 'deDE', 'Kam Tiefenzorn hat also endlich herausgefunden, wie es ist, den Tod selbst zu erfahren? Gut. Geschieht dem feigen Dunkeleisenabschaum recht. Ihr habt Eure Sache gut gemacht, $C. Die Gefallenen des Angriffs auf den Thandolübergang waren nur Opfer in einer Welt voller Krieg und Unfrieden. Ihre Familien werden Frieden in dem Wissen finden, dass Tiefenzorn die Strafe erhielt, die er verdiente. Der Tod von Langzopfs Bruder wurde ger"acht.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(631, 'deDE', 'Ihr durchsucht den winzigen Zwergenleichnam. Auf dem Helm k"onnt Ihr die deutlich eingravierten Buchstaben lesen: Ebenezer Rostlocke.', 0);
...
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(647, 'deDE', 'Na, wie l"aufts denn, $R?', 0);
DELETE FROM `quest_offer_reward_locale` WHERE `ID` = 647 AND `locale` = 'deDE';
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(647, 'deDE', 'Es geht doch nichts über Dunst MacKreels Fusel, der einem an kalten Tagen so richtig das Herz w"armt. Und ich dachte schon, der kleine Scheisser würde wieder mal mit der Bezahlung auf sich warten lassen. Ich danke Euch, Freund! Vielen herzlichen Dank!', 0);
...
-- UPDATE `quest_template_locale` SET `ObjectiveText1` = 'Sprengstoffbeh"alter zerst"ort', `VerifiedBuild` = 0 WHERE `ID` = 633 AND `locale` = 'deDE';
DELETE FROM `quest_request_items_locale` WHERE `ID` = 633 AND `locale` = 'deDE';
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(633, 'deDE', 'Der Beh"alter mit Sprengstoff muss zerst"ort werden!', 0);
DELETE FROM `quest_offer_reward_locale` WHERE `ID` = 633 AND `locale` = 'deDE';
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(633, 'deDE', 'Die letzte Brücke ist gerettet! Ihr habt K"onig Magni und dem Volk von Khaz Modan einen grossen Dienst erwiesen.$B$BJetzt k"onnen wir so lange durchhalten, bis Verst"arkung kommt...', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(634, 'deDE', 'Langzopf und seine mutigen Soldaten haben mein ehrliches Mitgefühl und Beileid. Die Nachricht von der Trag"odie am Thandolübergang und der Fall von Dun Modr lastet schwer auf meinem Herzen.$B$BAber Stromgarde ist gefallen! Darum befinden wir uns hier bei der Zuflucht. Wir müssen uns der Wiedereroberung unserer eigenen grossen Stadt stellen.$B$BEhre und Pflicht verlangen von uns, dass wir das Hochland nicht verlassen, bis erneut das m"achtige Banner des K"onigs über Stromgarde weht. Ich werde Langzopf Nachricht geben, dass er auf sich allein gestellt ist...', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(463, 'deDE', 'Die Wurzeln und Farne sagen Gutes über Euch, $GKleiner:Kleine;. Obwohl ich viele Namen habe, h"ore ich doch nur auf wenige. Aber Ihr m"ogt mich Rethiel nennen.$B$BUnd Ihr müsst mir lauschen... denn dieses Land leidet an eiternden Wunden, und ich betraue Euch damit, sie zu heilen.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(277, 'deDE', '... Danke. Ich werde diese Feuersteine zertrümmern und ins Meer werfen, auf dass sie nie wieder dazu verwendet werden k"onnen, lebendiges Holz zu verbrennen.', 0);

-- Quest 275 - add missing data
-- https://de.classic.wowhead.com/quest=275/schw"arendes-land + old GTDB WotLK files
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(306, 'deDE', 'Welch grausige Neuigkeiten! Immerhin haben 3 von ihnen überlebt. Doch wann wird das T"oten endlich aufh"oren? Ich sehne mich nach dem Tag, an dem K"onig Magnis Untertanen ohne Angst leben k"onnen.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(294, 'deDE', 'T"oten ist ein schmutziges Gesch"aft, aber Ihr habt Eure Sache gut gemacht, $N. Wenn ich nicht dazu verpflichtet w"are, hier beim Ausgrabungsleiter und Merrin zu bleiben, würde ich an Eurer Seite da unten Blut vergiessen.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(295, 'deDE', 'Ihr habt beim Aufr"aumen unter diesen Raptoren phantastische Arbeit geleistet, $N!', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(296, 'deDE', 'Danke, $N. Eure Anstrengungen hier werden nicht in Vergessenheit geraten. Viele unschuldige Zwerge starben an dieser St"atte, w"ahrend sie einfach nur ihrer Arbeit nachgingen. Die Rache, die Ihr über diese b"osen Kreaturen gebracht habt, sollte dafür sorgen, dass sie es sich zweimal überlegen, bevor sie je wieder K"onig Magnis Untertanen angreifen.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(299, 'deDE', 'Ah, der Goazstein ist vollst"andig! Ausgezeichnete Arbeit, $N. Wirklich ausgezeichnete Arbeit. Jetzt kann ich mit der kniffligen "Ubersetzung dieser Titanenschrift weitermachen. Ich kann bereits neue Worte erkennen! Hmm... es heisst hier "Alte G"otter... angekettet unter dem Land". Dies ist der Anfang von etwas Epischem.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(464, 'deDE', 'Gut gek"ampft, $N. Die Drachenmalorcs sind keine solche Bedrohung mehr wie zu den Zeiten, als sie noch Drachen unter sich hatten, aber sie sind dennoch harte Gegner.$B$BDer Drachenmalklan wird angeführt von Nek\'rosh, Sohn von Nekros, der vor vielen Jahren der Anführer des Drachenmalklans war. Nekros verwendete m"achtige Magie, um die roten Drachen zu b"andigen, aber als ihn diese Magie im Stich liess ... waren die Drachen nicht glücklich.$B$BNekros wurde get"otet, und sein Sohn hat Rache an den Drachen geschworen, die seinen Vater erschlugen.', 0);
...
INSERT INTO `quest_request_items_locale` (`ID`, `locale`, `CompletionText`, `VerifiedBuild`) VALUES
(474, 'deDE', 'Habt Ihr Nek\'rosh get"otet?', 0);
DELETE FROM `quest_offer_reward_locale` WHERE `ID` = 474 AND `locale` = 'deDE';
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(474, 'deDE', 'Saubere Arbeit, $N. Ihr habt den Orcs vom Drachenmalklan einen deutlichen Schlag verpasst. Vielleicht erholen sie sich nie wieder davon. Ausserdem hat die Zerst"orung dieser Katapulte den Hafen von Menethil gesichert.$B$BIhr seid $Gein vorzüglicher:eine vorzügliche:r; $R, und das K"onigreich von Eisenschmiede belohnt die, die ihm gut dienen.', 0);
...
INSERT INTO `quest_offer_reward_locale` (`ID`, `locale`, `RewardText`, `VerifiedBuild`) VALUES
(1302, 'deDE', 'James Hyal, James Hyal... Warum kommt mir der Name so bekannt vor?$B$BNatürlich! Der Vorfall im Gasthaus Zur süssen Ruh. Wenn Ihr Informationen habt, was dort geschehen ist, beschw"ore ich Euch, mit Hauptmann Mumm darüber zu sprechen. Er leitet die Ermittlungen.', 0);
