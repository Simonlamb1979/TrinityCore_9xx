...
CREATE TABLE `realmlist` (
  ...
  `gamebuild` int(10) unsigned NOT NULL DEFAULT '43114',
...
INSERT INTO `realmlist` VALUES (1,'亚边个魔兽世界','192.168.191.100','192.168.191.100','255.255.255.0',8085,0,2,1,0,0,43206,1,1);
...
INSERT INTO `updates_include` VALUES ('$/sql/custom/auth','RELEASED'),('$/sql/updates/auth','RELEASED');
...
-- Dump completed on 2022-04-20 19:23:39
